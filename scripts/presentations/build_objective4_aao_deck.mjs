...
export async function buildDeck({ runtimeRoot, outputPptx, disclosureText }) {
  ...
  let s = slide(); addText(s, "Baseline Clinical Risk Stratification When Gene Expression Profiling Is Unavailable in Uveal Melanoma", { left: 70, top: 155, width: 1120, height: 180 }, { fontSize: 52, bold: true }); addText(s, "AAO 2026 • PO203\nObjective 4", { left: 74, top: 390, width: 700, height: 90 }, { fontSize: 24, color: GRAY }); addNote(s, "Accepted AAO abstract PO203; generated Objective 4 report Start_Here.");
