...
#'
#' @examples
#' merge_cohort_tables(full_data, restricted_data, "~/Workspaces/uveal-melanoma/runtime/Analysis/merged_tables/")
...
#'
#' @examples
#' create_all_combined_forest_plots("~/Workspaces/uveal-melanoma/runtime", c("full", "restricted"))
...
#'
#' @examples
#' merge_recurrence_metastatic_progression_tables(full_data, restricted_data, "~/Workspaces/uveal-melanoma/runtime/Analysis/merged_tables/")
...
#'
#' @examples
#' merge_adverse_events_tables(full_data, restricted_data, "~/Workspaces/uveal-melanoma/runtime/Analysis/merged_tables/")
...
#'
#' @examples
#' export_repeat_treatment_descriptive_stats(full_data, restricted_data, "~/Workspaces/uveal-melanoma/runtime/Analysis/")
