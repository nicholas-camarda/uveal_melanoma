if (!identical(Sys.getenv("OCULAR_TESTTHAT_BOOTSTRAPPED"), "true")) {
    ...
    input_export_root <- file.path(export_parent_dir, "uveal_melanoma")
    export_analysis_dir <- file.path(export_root, "Analysis")
    dir.create(file.path(input_export_root, "Original Files"), recursive = TRUE, showWarnings = FALSE)
    ...
    Sys.setenv(DATA_DIR = input_export_root)
    ...
    Sys.setenv(RAW_DATA_DIR = file.path(input_export_root, "Original Files"))
    ...
    assign("INPUT_EXPORT_ROOT", input_export_root, envir = .GlobalEnv)
    assign("TEST_OUTPUT_DIR", file.path(runtime_root, "test_output"), envir = .GlobalEnv)
    assign("DATA_DIR", input_export_root, envir = .GlobalEnv)
    ...
    assign("RAW_DATA_DIR", file.path(input_export_root, "Original Files"), envir = .GlobalEnv)
