...
import JSZip from "../../scripts/presentations/node_modules/jszip/lib/index.js";
...
async function fixtureRoot({ gateStatus = "review", comparatorStatus = "pass", includeSheet = true } = {}) {
  ...
  await fs.writeFile(path.join(root, "objective4-aao-gate.json"), JSON.stringify({ gate_version: 1, status: gateStatus, accepted_abstract_id: "30085896", comparisons: { auc: { molecular_surrogate: { candidate: 0.563 } } }, reasons: [] }));
