## Purpose
Define Objective 2 data-readiness, sparse-support, assumption-status, and reproducibility guardrails so safety outputs fail explicitly and use prepared Objective 0 fields.
