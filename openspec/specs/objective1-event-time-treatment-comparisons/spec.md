# objective1-event-time-treatment-comparisons Specification

## Purpose
Define the active Objective 1 recurrence and metastatic-progression treatment-comparison contract, preserving collaborator-requested binary summaries while adding competing-risk cumulative incidence as co-primary follow-up-aware evidence.
