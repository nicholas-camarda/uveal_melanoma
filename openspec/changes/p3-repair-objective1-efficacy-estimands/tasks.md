...
- [ ] 3.1 Decide whether subgroup table workbooks will be generated or removed from the documented contract
- [ ] 3.2 Align subgroup runtime outputs, docs, and tests to that decision
- [ ] 3.3 Add explicit exploratory labeling for sparse-support subgroup surfaces
