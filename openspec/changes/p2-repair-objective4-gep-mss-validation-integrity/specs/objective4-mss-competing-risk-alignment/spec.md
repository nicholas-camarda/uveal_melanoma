...
Objective 4 MUST NOT publish a simple MSS summary that uses a different observed-risk definition from the corrected primary MSS validation path unless that output is explicitly labeled as QC-only.
