...
- Add assumption, sparsity, and missingness guardrails so Objective 2 outputs fail softly and read honestly.
...
- `objective2-assumption-and-missingness-guardrails`: Objective 2 handles missingness, sparse support, and untested assumptions explicitly in outputs and tests.
...
- Affected derived variables and methods docs: [data_derivation.R](/Users/ncamarda/Projects/uveal_melanoma/scripts/data_helper/data_derivation.R), [STATISTICAL_METHODS.md](/Users/ncamarda/Projects/uveal_melanoma/docs/STATISTICAL_METHODS.md)
